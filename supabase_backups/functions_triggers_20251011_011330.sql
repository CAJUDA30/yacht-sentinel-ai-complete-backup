...
\restrict bdbmOgvnvb2bBpa5RbSIcb2xSRITQaUyrn2TNvCMl2ylAojUPdEcC7VWUPKGYwa
...
--
-- Name: ai_system_config Authenticated delete access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Authenticated delete access" ON public.ai_system_config FOR DELETE TO authenticated USING (true);


--
-- Name: audit_workflows Authenticated delete access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Authenticated delete access" ON public.audit_workflows FOR DELETE TO authenticated USING (true);


--
-- Name: inventory_items Authenticated delete access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Authenticated delete access" ON public.inventory_items FOR DELETE TO authenticated USING (true);


--
-- Name: system_settings Authenticated delete access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Authenticated delete access" ON public.system_settings FOR DELETE TO authenticated USING ((auth.uid() IN ( SELECT users.id
   FROM auth.users
...
--
-- Name: ai_providers_unified Authenticated read access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Authenticated read access" ON public.ai_providers_unified FOR SELECT TO authenticated USING (true);
...
--
-- Name: inventory_items Authenticated read access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Authenticated read access" ON public.inventory_items FOR SELECT TO authenticated USING (true);
...
--
-- Name: system_settings Authenticated read access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Authenticated read access" ON public.system_settings FOR SELECT TO authenticated USING (true);
...
--
-- Name: yachts Authenticated read access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Authenticated read access" ON public.yachts FOR SELECT TO authenticated USING (true);
...
--
-- Name: ai_providers_unified Authenticated update access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Authenticated update access" ON public.ai_providers_unified FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
...
--
-- Name: user_roles Authenticated users access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Authenticated users access" ON public.user_roles TO authenticated USING (((auth.uid() = user_id) OR (auth.uid() IN ( SELECT users.id
   FROM auth.users
  WHERE ((users.email)::text = 'superadmin@yachtexcel.com'::text))))) WITH CHECK (((auth.uid() = user_id) OR (auth.uid() IN ( SELECT users.id
   FROM auth.users
  WHERE ((users.email)::text = 'superadmin@yachtexcel.com'::text)))));
...
--
-- Name: ai_providers_unified Authenticated write access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Authenticated write access" ON public.ai_providers_unified FOR INSERT TO authenticated WITH CHECK (true);
...
--
-- Name: ai_providers_unified Service role full access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Service role full access" ON public.ai_providers_unified TO service_role USING (true) WITH CHECK (true);
...
--
-- Name: inventory_items Service role full access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Service role full access" ON public.inventory_items TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "Service role full access" ON public.system_settings TO service_role USING (true) WITH CHECK (true);
...
--
-- Name: yachts Service role full access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Service role full access" ON public.yachts TO service_role USING (true) WITH CHECK (true);


--
-- Name: ai_providers_unified Superadmin and service delete access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Superadmin and service delete access" ON public.ai_providers_unified FOR DELETE TO authenticated USING ((auth.uid() IN ( SELECT users.id
   FROM auth.users
  WHERE ((users.email)::text = 'superadmin@yachtexcel.com'::text))));
...
--
-- Name: POLICY "Superadmin full access" ON ai_health; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: ai_providers_unified Superadmin full access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Superadmin full access" ON public.ai_providers_unified TO authenticated USING ((auth.uid() IN ( SELECT users.id
   FROM auth.users
  WHERE ((users.email)::text = 'superadmin@yachtexcel.com'::text)))) WITH CHECK ((auth.uid() IN ( SELECT users.id
   FROM auth.users
  WHERE ((users.email)::text = 'superadmin@yachtexcel.com'::text))));
...
--
-- Name: POLICY "Superadmin full access" ON ai_providers_unified; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: system_settings Superadmin full access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Superadmin full access" ON public.system_settings TO authenticated USING ((auth.uid() IN ( SELECT users.id
   FROM auth.users
  WHERE ((users.email)::text = 'superadmin@yachtexcel.com'::text)))) WITH CHECK ((auth.uid() IN ( SELECT users.id
   FROM auth.users
  WHERE ((users.email)::text = 'superadmin@yachtexcel.com'::text))));
...
--
-- Name: POLICY "Superadmin full access" ON system_settings; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: yachts Superadmin full access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Superadmin full access" ON public.yachts TO authenticated USING ((auth.uid() IN ( SELECT users.id
   FROM auth.users
  WHERE ((users.email)::text = 'superadmin@yachtexcel.com'::text)))) WITH CHECK ((auth.uid() IN ( SELECT users.id
   FROM auth.users
  WHERE ((users.email)::text = 'superadmin@yachtexcel.com'::text))));
...
\unrestrict bdbmOgvnvb2bBpa5RbSIcb2xSRITQaUyrn2TNvCMl2ylAojUPdEcC7VWUPKGYwa
