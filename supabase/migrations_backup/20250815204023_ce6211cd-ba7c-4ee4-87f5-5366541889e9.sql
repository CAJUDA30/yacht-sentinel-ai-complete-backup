-- Enhanced database schema for multi-model AI orchestration and behavior analytics (without vector types)
...
CREATE INDEX IF NOT EXISTS idx_shared_knowledge_library_text_search ON public.shared_knowledge_library USING gin(to_tsvector('english', content_text));
