-- =============================================
-- PHASE 1B: CORRECTED SECURITY & INFRASTRUCTURE MIGRATION
-- Create settings tables and fix RLS policies without yacht_id references
-- =============================================
...
-- =============================================
-- FIX EXISTING RLS POLICIES - BASIC AUTHENTICATED ACCESS
-- =============================================

-- Update inventory policies to require authentication (without yacht references for now)
...
-- Create basic authenticated access policies
CREATE POLICY "Authenticated users can manage inventory folders"
...
-- Create updated trigger function for security audit logging
